...
# Exactly the end-to-end stage-2 RF retrain, on the trained segmentation model's held-out 64 val panels.
...
train_rf_from_val("models/segmentation_model.pt", VAL_H5, VAL_CSV, ids,
