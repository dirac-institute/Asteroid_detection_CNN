#!/bin/bash
#SBATCH --job-name=adc-seg_model-big
#SBATCH --requeue
...
#SBATCH --output=/sdf/home/m/mrakovci/logs/ADCNN_seg_big_%j.out
set -eo pipefail
...
srun python3 -u -m ADCNN.training.diffim_train \
  ...
  --tile 128 --epochs 50 --batch-size 24 --lr 0.0003 --wd 1e-5 \
