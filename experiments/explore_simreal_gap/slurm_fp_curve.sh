...
srun python3 -u experiments/explore_simreal_gap/fp_curve.py \
  "$REPO/experiments/diffim_runs/pilot_v7_reg2/ckpts/v7_reg2_best_scripted.pt::reg2" \
  "$REPO/experiments/diffim_runs/pilot_v7_realistic/ckpts/v7_realistic_scripted.pt::v7-realistic-baseline"
