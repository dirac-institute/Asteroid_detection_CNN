...
#SBATCH --output=/sdf/home/m/mrakovci/logs/ADCNN_v7_stream_%j.out
set -eo pipefail
...
echo "=== v7 streaming train === $(date -Is)"
srun python3 -u -m ADCNN.training.diffim_train \
  --run-name pilot_v7_stream \
