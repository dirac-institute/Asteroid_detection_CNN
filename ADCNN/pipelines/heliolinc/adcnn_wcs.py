...
def main():
    ...
    ap.add_argument("--cands", default=str(REPO / "ADCNN/pipelines/heliolinc/run_adcnn/catalog.csv"),
                    help="Stage-A catalog (csv/parquet) with visit,detector,x,y[,band,score_rf]")
    ap.add_argument("--out", default=str(REPO / "ADCNN/pipelines/heliolinc/run_adcnn/adcnn_dets.csv"))
