...
> Direct real-data measurement (off-ecliptic, **3 fields pooled, 273 same-night pairs** so far), S=0.80,
> full faint completeness (field-to-field FP varies: field 0 dirty 0.32/pair, field 1 clean 0.03):
> - floor-B (recurrence veto only, TP-safe, full recall): **λ=0.136/pair = 138× over** 1.35e-3.
> - floor-E (recurrence + tight geometry + brightness, ~half recall): **λ=0.037/pair = 49× over**.
> - At S=0.90 (costs ~25% completeness): 0 false / 273 pairs → 95% UL **1.1e-2 = 8× over**.
