...
>    over 556 real off-ecliptic pairs (6 fields) → λ point est. 0, 95% UL 5.4e-3 = 4× over 3σ** (pinning in
>    progress; growing toward ~1000 pairs / 10 fields → ~2× UL). Frontier: χ² {3.0:C0.35, 4.0:0.43, 6.0:0.57}.
