...
def main():
    ...
    ap.add_argument("--dets", default=str(REPO / "ADCNN/pipelines/heliolinc/NEO_small/adcnn_dets.csv"))
    ap.add_argument("--manifest", default=str(REPO / "ADCNN/pipelines/heliolinc/NEO_small/manifest.csv"))
    ...
    ap.add_argument("--out", default=str(REPO / "ADCNN/pipelines/heliolinc/NEO_small_v2/adcnn_dets_veres.csv"))
    a = ap.parse_args()
