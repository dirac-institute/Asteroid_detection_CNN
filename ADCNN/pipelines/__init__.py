"""End-to-end entry points for the ADCNN diffim asteroid-trail pipeline.
  ...
  train_end_to_end   train the v7 detector (reg2 recipe) then the RandomForest 2nd stage
  run_inference      run v7 + RF on diffim panels -> scored candidate detections
