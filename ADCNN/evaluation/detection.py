...
# Geometry primitives live in geometry.py; aliased to the historical private names
# so the object/pixel-confusion call sites below read unchanged.
from ADCNN.evaluation.geometry import (
    create_disk_mask as _disk_mask,
    create_line_mask as _line_mask,
    label_components as _label_components_fds,
)
from ADCNN.evaluation.plots import (  # re-exported; notebooks call evals.plot_*
