...
[`Evaluation.ipynb`](https://nbviewer.org/github/dirac-institute/Asteroid_detection_CNN/blob/diffim/Evaluation/Evaluation.ipynb)
· [`Evaluation_Real.ipynb`](https://nbviewer.org/github/dirac-institute/Asteroid_detection_CNN/blob/diffim/Evaluation/Evaluation_Real.ipynb)
